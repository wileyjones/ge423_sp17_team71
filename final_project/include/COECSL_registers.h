...
#define SET_LVDATA_FROM_LINUX (SETGPIO01 = 0x00000004)
#define CLR_LVDATA_FROM_LINUX (CLRGPIO01 = 0x00000004)
#define GET_LVDATA_FROM_LINUX ((OUTGPIO01 & 0x00000004)>>2)
...
// LabView using same as VB 
#define SET_LVDATA_TO_LINUX (SETGPIO01 = 0x00000008)
#define CLR_LVDATA_TO_LINUX (CLRGPIO01 = 0x00000008)
#define GET_LVDATA_TO_LINUX ((OUTGPIO01 & 0x00000008)>>3)
